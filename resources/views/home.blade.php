...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center" style=" font-size: xx-large" >الواجهه الرئيسية</div>

                <div class="d-flex flex-wrap mb-3" style="    place-content: center;">
                    @foreach ($services as $service)

                    <div class="card m-3 p-3" >
                        <img class="card-img-top img-fluid" style="max-width: 250px;" src="{{$service['piclocation']}}" alt="Card image cap">
                        <div class="card-body">
                            <hr>
